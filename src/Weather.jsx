...
const Weather = () => {
  ...
  return (
    <main className="h-[100vh] w-full px-28 py-16 bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1558486012-817176f84c6d?q=80&w=1804&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
      ...
      <h1 style={{ textAlign: 'center', fontSize: '62px', color: 'black', fontFamily: 'Times New Roman, sans-serif', fontWeight: 'bold' }}>WEATHER DASHBOARD</h1>
        <input
          type="text"
          placeholder="Search..."
      ...
      <h1 className="absolute bottom-16 left-28 text-lg font-medium">Developed by <a href="https://github.com/kartikshaarma" target="blank" className="font-bold underline">Kartik Sharma</a></h1>
    </main>
  );
};
